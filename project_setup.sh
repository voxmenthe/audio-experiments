...
python -m ipykernel install --user --name=AX --display-name "Audio Experiments" # install globally outside of poetry

echo "Jupyter kernel 'AX' (Audio Experiments) has been installed."
